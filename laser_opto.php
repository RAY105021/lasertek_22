...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 雷射機銷售, 設備專業保養維護, 設計各項雷射運用設備, 被動元件產業, PCB/FPC產業, 半導體產業, 光電產業,光電產業LED substrate drilling , " />
                                    ...
                                    <div class="product_select100">
                                        <ul class="product_menu_select">
                                            <li>
                                                ...
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    <option value="#" selected="true">選擇產品</option>
                                                    <option value="laser_opto.php" class="product_menu_select_class" selected="true">LED substrate drilling ALL</option>
