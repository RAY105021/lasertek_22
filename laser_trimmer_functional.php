...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 雷射機銷售, 設備專業保養維護, 設計各項雷射運用設備, 被動元件產業, PCB/FPC產業, 半導體產業, 光電產業,Laser Trimmer-Functional Trimmer, " />
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_at_scriber_as01005uv.php"> • AS-01005UV AT劃線機</option> <!-- 新增 AS-01005UV AT Scriber -->
                                                    <option value="laser_at_scriber_as0201.php"> • AS-0201 AT劃線機</option> <!-- 新增 AS-0201 AT Scriber -->
                                                    <option value="laser_trimmer_functional.php" class="product_menu_select_class" selected="true"><samp>Functional Embedded Resistor Trimmer ALL</samp></option> <!-- 新增 -->
