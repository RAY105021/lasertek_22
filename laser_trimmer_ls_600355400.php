...
<head>
    <title>雷科-LASER(雷射)設備 Laser Trimmer-Thin Film Trimmer FPC UV雷射切割機/LS-355-600 & LS-355-400</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Thin Film Trimmer,FPC UV雷射切割機/LS-355-600 & LS-355-400" />
    <meta name="description" content="雷科-LASER(雷射)設備 Laser Trimmer-Thin Film Trimmer FPC UV雷射切割機/LS-355-600 & LS-355-400" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Trimmer-Thin Film Trimmer FPC UV雷射切割機/LS-355-600 & LS-355-400</h1>
            ...
            <section class="ltt_news_all02">
                ...
                <div id="breadcrumbs">
                    <ul>
                        ...
                        <li>FPC UV雷射切割機/LS-355-600 & LS-355-400</li>
                    </ul>
                </div>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_ls_600355400.php" selected="true"> • FPC UV雷射切割機/LS-355-600 & LS-355-400</option>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film24.png" alt="FPC UV雷射切割機/LS-355-600 & LS-355-400">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <a aria-label="下載" data-balloon-pos="up" href="download/laser/FPC UV Cutting System-LS2-355-600-Galvo(Ch).pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_trimmer_ls_1070c430.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_trimmer_thin_film.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_trimmer_ls_cot100.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>FPC UV雷射切割機</h5>
                                <p>LS-355-600 & LS-355-400</p>
                            </div>
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">軟性FPC PCB(軟性電路板或軟硬複合板) 之外觀輪廓成型切割。</samp></li>
                                <li class="ltt_page_text_li_samp">解決傳統衝壓成型需製造數種模具的時間並節省模具成本。</samp></li>
                                <li class="ltt_page_text_li_samp">提供優良的彈性,任何基板只要載入CAD圖檔就能進行。</samp></li>
                                <li class="ltt_page_text_li_samp">具使用彈性對各種不同形狀的FPC作外型切割。</samp></li>
                                <li class="ltt_page_text_li_samp">高精密加工。</samp></li>
                                <li class="ltt_page_text_li_samp">Fine Pitch 高精度的加工提昇產品材料比。</samp></li>
                            </ul>
                            ...
                            <ul class="ltt_page_text">
                                ...
                                <li><span class="ltt_page_text_span">【產品型號】</span>
                                    <span class="ltt_page_text_color">LS-355-600 & LS-355-400。</span>
                                </li>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all ">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film24.png" alt="FPC UV雷射切割機 LS-355-600">
                        <samp class="product_features_type">FPC UV雷射切割機 LS-355-600</samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film24_01.png" alt="光纖雷射切割機">
                        <samp class="product_features_type"></samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film24_02.png" alt="光纖雷射切割機">
                        <samp class="product_features_type"></samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film24_03.png" alt="FPC UV雷射切割機 LS-355-400">
                        <samp class="product_features_type">FPC UV雷射切割機 LS-355-400</samp>
                    </div>
                </div>
                ...
                <div class="ltt_box_content_all">
                    <table class="wow slideInUp">
                        <tbody>
                            <tr>
                                <th colspan="2">LS2-355-600雙平台軟板切割機</th>
                            </tr>
                            <tr>
                                <th width="35%">適用產品</th>
                                <th width="65%">軟性電路板、PI 及銅類等材質皆可切割</th>
                            </tr>
                            <tr>
                                <th rowspan="6">雷射資訊</th>
                                <td>雷射種類：UV Nd：YVO4 Laser</td>
                            </tr>
                            <tr>
                                <td>雷射波長：355nm</td>
                            </tr>
                            <tr>
                                <td>雷射功率：12W (可客製化配置)</td>
                            </tr>
                            <tr>
                                <td>頻率範圍：20KHz~200KHz</td>
                            </tr>
                            <tr>
                                <td>冷卻方式：水冷</td>
                            </tr>
                            <tr>
                                <td>雷射加工型態：快速掃瞄頭導光</td>
                            </tr>


                            <tr>
                                <th rowspan="11">設備功能</th>
                                <td>機台最大行程600mm × 600mm (可客製化配置)</td>
                            </tr>
                            <tr>
                                <td>加工最大速度可達3000 mm/sec</td>
                            </tr>
                            <tr>
                                <td>加工雙Table 平台，大幅減少上下料時間，換料及切割可同時作動</td>
                            </tr>
                            <tr>
                                <td>可執行多個相同模式的切割區塊</td>
                            </tr>
                            <tr>
                                <td>XY軸可同步移動</td>
                            </tr>
                            ...
                            <tr>
                                <th rowspan="9">軟體資訊</th>
                                <td>自行開發的中文化介面</td>
                            </tr>
                            <tr>
                                <td>Mark 點定位CCD(十六種不同標靶搜尋定位</td>
                            </tr>
                            <tr>
                                <td>三種標靶類型(圓型、多邊型、特定圖樣)</td>
                            </tr>
                            <tr>
                                <td>CCD & Laser offset 計算</td>
                            </tr>
                            <tr>
                                <td>可雕刻任意文字、影像、1D 及2D 條碼、流水號等功能</td>
                            </tr>
                            <tr>
                                <td>參數紀錄功能</td>
                            </tr>
