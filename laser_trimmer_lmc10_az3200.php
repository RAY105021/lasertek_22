...
<head>
    <title>雷科-LASER(雷射)設備 Laser Trimmer Thin Film Trimmer - 雙頭雷射條碼雕刻機 / LM-C10-AZ3200</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Thin Film Trimmer,雙頭雷射條碼雕刻機 / LM-C10-AZ3200" />
    <meta name="description" content="雷科-ASER(雷射)設備 Laser Trimmer Thin Film Trimmer - 雙頭雷射條碼雕刻機 / LM-C10-AZ3200" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Trimmer-Thin Film Trimmer 雙頭雷射條碼雕刻機/LM-C10-AZ3200</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_lmc10_az3200.php" selected="teue"> • 雙頭雷射條碼雕刻機/LM-C10-AZ3200</option>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film17.png" alt="雙頭雷射條碼雕刻機/LM-C10-AZ3200">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <a aria-label="下載" data-balloon-pos="up" href="download/laser/SMT Dual Head PCB Laser Marking Barcode Machine_雙頭雷射條碼雕刻機.pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all ">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film17.png" alt="雙頭雷射條碼雕刻機/LM-C10-AZ3200">
                        <samp class="product_features_type">雙頭雷射條碼雕刻機/LM-C10-AZ3200</samp>
                    </div>
